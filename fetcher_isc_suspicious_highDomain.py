...
feedaddr = 'https://isc.sans.edu/feeds/suspiciousdomains_High.txt'
feedID = 'isc_suspicious_high'
mkey = 'fetcher_isc_suspicious_high:feeddata'
killchain = 'unknown'
...
for x in splitlines:
	...
	print("%s,%s,%s,%s" % (x, feedID, killchain, 'ISC SANS suspicious domains HIGH'))
