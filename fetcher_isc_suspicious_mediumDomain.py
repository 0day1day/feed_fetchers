...
feedaddr = 'https://isc.sans.edu/feeds/suspiciousdomains_Medium.txt'
feedID = 'isc_suspicious_medium'
mkey = 'fetcher_isc_suspicious_medium:feeddata'
killchain = 'unknown'
...
for x in splitlines:
	...
	print("%s,%s,%s,%s" % (x, feedID, killchain, 'ISC SANS suspicious domains MEDIUM'))
